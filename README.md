...
체크박스로 고른 언론사에서 기사를 수집해 txt로 모으고, Kiwi 형태소 분석으로 조사·어미를 걷어낸 뒤
빈도를 세어 **핫 키워드 랭킹**을 뽑는 **로컬 단일 사용자 도구**다.
수집 대상은 **IT/AI · 엔터 · 스포츠 · 경제 · 증권** 다섯 카테고리이고, 언론사를 등록할 때 카테고리를 하나
지정한다 — 크롤 실행·수집 결과·핫 키워드 세 화면 모두 카테고리로 좁혀 볼 수 있다.
